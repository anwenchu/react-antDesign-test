...
public class ElementController extends AbstractController{
     ...
     */
    @ApiOperation(value = "查询所有元素", notes = "查询所有元素")
    @GetMapping(value = "/elementforpage")
    public ResponseEntity findByPageId(@RequestParam(value = "pageId") String pageId) {
        Long isDelete = 0L;
        return wrapperSupplier(() -> elementRepository.findElementDomainByPageIdAndIsDeleteAndElementNameIsNotNull(pageId,isDelete), false);
